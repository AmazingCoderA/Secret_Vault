...
const ru: Record<string, string> = {
  ...
  'Theme': 'Тема', 'Calculator and vault appearance': 'Оформление калькулятора и хранилища', 'Forest': 'Лес', 'Midnight': 'Полночь', 'Graphite': 'Графит', 'Ocean': 'Океан', 'Violet': 'Фиолет', 'Rose': 'Роза', 'Aurora': 'Аврора', 'Ember': 'Уголь', 'White': 'Белая', 'Custom': 'Своя',
