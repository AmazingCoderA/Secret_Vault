...
const ru: Record<string, string> = {
  ...
  'A little order\nin everyday numbers.': 'Немного порядка\nв повседневных числах.', 'Result': 'Результат', 'Delete digit': 'Удалить цифру', 'Decimal point': 'Десятичная точка',
  ...
  'Theme': 'Тема', 'Calculator and vault appearance': 'Оформление калькулятора и хранилища', 'Forest': 'Лес', 'Midnight': 'Полночь', 'Graphite': 'Графит', 'Ocean': 'Океан', 'Violet': 'Фиолет', 'Rose': 'Роза', 'Aurora': 'Аврора', 'Ember': 'Уголь',
  'Custom accent color': 'Свой акцентный цвет', 'Mask file names': 'Маскировать имена файлов', 'Show “File 1”, “File 2” instead of names': 'Вместо названий показывать «Файл 1», «Файл 2»', 'Secure record deletion': 'Безопасное удаление записей', 'SQLite wipes freed pages': 'SQLite затирает освобождённые страницы',
  ...
  'Confirm changes': 'Подтверждение изменений', 'Your current password is required to apply changes': 'Текущий пароль нужен для применения изменений', 'Current password': 'Текущий пароль', 'optional': 'необязательно', 'Repeat new password': 'Повтор нового пароля', 'Applying…': 'Применяем…', 'Save settings': 'Сохранить настройки',
  ...
  'Unknown theme.': 'Неизвестная тема.', 'Unknown protection mode.': 'Неизвестный режим защиты.', 'Invalid settings.': 'Некорректные настройки.', 'Invalid interface color.': 'Некорректный цвет интерфейса.',
  ...
  'Operation cancelled.': 'Операция прервана.', 'Internal error. Restart the application.': 'Внутренняя ошибка. Перезапустите приложение.'
};
